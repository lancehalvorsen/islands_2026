defmodule IslandsEngine.Board do
  ...
  @island_keys [:atoll, :dot, :l_shape, :s_shape, :square]

  def new() do
    %{}
  end

  def position_island(board, key, %Island{} = island) when key in @island_keys do
  ...
  def position_island(_board, _key, _island) do
    {:error, :invalid_island_key}
  end
